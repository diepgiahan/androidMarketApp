package com.example.admin.finalprojectcs426finalproject.Account.chatbox;
...
public class MessageAdapter extends FirebaseListAdapter<ChatMessage> {
    ...
    public MessageAdapter(ChatboxActivity activity, Class<ChatMessage> modelClass, int modelLayout, DatabaseReference ref) {
